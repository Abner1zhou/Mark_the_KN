...
@desc:  BERT中的run_classifiter.py 删减了一下
@date:2020/4/14
"""
...
from model.bert.bert_model import modeling
from model.bert.bert_model import optimization
...
class Baidu_95_Multi_Label_Classification_Processor(DataProcessor):
    ...
    def load_examples(data_dir):
        with open(os.path.join(data_dir, "token_in.txt"), encoding='utf-8') as token_in_f:
            with open(os.path.join(data_dir, "predicate_out.txt"), encoding='utf-8') as predicate_out_f:  # 预测结果
